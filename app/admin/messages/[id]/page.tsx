...
export default function AdminMessageDetailPage() {
  ...
  const record = useMemo(() => findRecord(records, 'contact', id), [records, id])
  ...
  if (!record) {
    return (
      <div className="mx-auto max-w-2xl text-center">
        <p className="font-heading text-2xl text-emerald-deep">Message not found</p>
        <Link href={adminRoutes.messages} className="btn-primary mt-6 inline-block">
          Back to messages
        </Link>
      </div>
    )
